myFocus.pattern.extend({//*********************pithy******************
    'mF_pithy': function (settings, $) {
        ...
        $thumbBox.find('img').each(function () { $(this).css({ height: thuHeight - 12, width: p.thumbWidth }) }); //减去padding+margin+border
...
myFocus.config.extend({
    'mF_pithy': {//可选个性参数
        ...
        thumbBtnHeight: 15, //略缩图导航(prev/next)按钮的高度
        thumbWidth: 153//略缩图总宽度
    }
});